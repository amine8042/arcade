    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('TECHNICIEN', 'Technicien'), ('INVITE', 'Invite')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cout_maintenance', models.DecimalField(decimal_places=2, max_digits=10)),
                ('machine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.machinearcade')),
